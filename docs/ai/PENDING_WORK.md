...
- [ ] Lazy loading of signed media URLs (optimizing lists/adapters).
- [ ] Better workspace switch improvements (UI/UX and seamless data refresh).
...
- [ ] **APK Install/Version Compare**: (Deferred) Allow downloading/installing APKs directly and comparing version diffs.
- [ ] **Background Uploads**: (Deferred) Move heavy batch uploads to persistent background services/WorkManager.
